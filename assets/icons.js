...
(function (global) {
  ...
  var P = {
    ...
    film:      '<rect x="3.4" y="5.4" width="17.2" height="13.2" rx="2"/><path d="M8.4 5.6v12.8M15.6 5.6v12.8M3.6 12h16.8"/>',
    ...
    piggy:     '<path d="M20 12.6c0 3.4-3.4 5.8-7.6 5.8-.9 0-1.7-.1-2.5-.3l-2.7 1.5.3-2.6A5.9 5.9 0 0 1 4.8 12c0-3.4 3.4-5.8 7.6-5.8S20 8.8 20 12.6Z"/><path d="M15.4 11.4h.2"/><path d="M4.8 11.2H3.4"/>',
